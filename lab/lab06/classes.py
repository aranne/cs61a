...
class TutorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        "*** YOUR CODE HERE ***"
        for _ in range(3):
            opponent.play(0)                    # Discard first 3 cards.
            opponent.draw()                     # Draw 3 new cards.
...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        opponent.deck.cards = [opponent_card for opponent_card in opponent.deck.cards if opponent_card.attack != other_card.attack or opponent_card.defense != other_card.defense]
